...
do
    ...
    srun --overcommit -N $NUM_NODES --ntasks $NUM_TASKS -o "smallJob$NUM_NODES.log" ../../apps/btcMiner/miner.out $INPUT_FILE $NUM_TASKS $MAX_ITERATIONS $P_PROB $OUT_PATH synthetic &
done
wait
echo "$RESULTS_PREFIX done"


RESULTS_PREFIX=smalljob-real
